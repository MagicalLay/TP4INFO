...
public class VisuMobile implements ActionListener
{
	...
	public VisuMobile()
	{
		...
		// on commence à le créer maintenant pour qu'il existe lors de l'affichage....
		createMobile();
		...
		conteneur = new JPanel()
		{
			public void paintComponent(Graphics g)
			{
				...
				{
					g.drawString("Pas encore résolu !", milieu - 20, 5 * PETIT);
				}
			}
		};
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
			// on crée le nouveau mobile
			createMobile();
			// on vérifie l'encombrement
			if (!mob.longueursCoherentes())
			{
				JOptionPane.showMessageDialog(f, "Encombrement non cohérent !");
